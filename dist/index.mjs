...
var Only = require("@uiw/react-only-when");
  ...
  var chainedClasses = classNames.reduce(function(acc, current) {
    if (current) {
      acc += ""
        .concat(space)
        .concat(prefix, "-")
        .concat(current); // we must keep spaces between class names
    }
    return acc;
  }, "");
...
var CarouselWrapper = styled.div(
  _templateObject$2 ||
...
var Track = function Track(_ref) {
  ...
  var originalChildren = React.Children.map(children, function(child, idx) {
    ...
    var childToRender = autoTabIndexVisibleItems
    ...
    return /*#__PURE__*/ React.createElement(
      "div",
      {
        className: cssPrefix(
          itemClass,
          "".concat(itemClass, "-").concat(idx),
          "".concat(itemClass, "-").concat(isVisible ? "visible" : "hidden"),
          isPrevItem && "".concat(itemClass, "-prev"),
          isNextItem && "".concat(itemClass, "-next")
        ),
      },
...
var Arrow = function Arrow(_ref) {
  ...
  var styleObj = _objectSpread2(
    _objectSpread2({}, rotateStyle(direction)),
    style
  );
  return /*#__PURE__*/ React.createElement(
    Button,
    _extends(
      {
        ...
        className: cx(
          arrowClassname,
          "".concat(arrowClassname, "-").concat(direction)
        ),
        style: styleObj,
      },
      rest
  ...
  return _createClass(DotContainer, [
    {
      ...
      value: function render() {
        ...
        return /*#__PURE__*/ React.createElement(Dot, {
          ...
          active: active,
          className: ""
            .concat(cssPrefix("dot"), " ")
            .concat(active ? cssPrefix("dot_active") : ""),
        });
      },
    },
  ]);
...
var Carousel = /*#__PURE__*/ (function(_React$Component) {
  function Carousel() {
    ...
    _defineProperty(_this, "state", {
      ...
      activeIndex:
        _this.props.initialActiveIndex || _this.props.initialFirstItem,
    ...
    _defineProperty(_this, "onContainerResize", function(sliderContainerNode) {
      ...
      if (
        ...
        _this.state.sliderContainerWidth === newSliderContainerWidth
      ) {
    ...
    _defineProperty(_this, "tiltMovement", function(position) {
      ...
      var duration =
        arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 150;
      _this.setState(function(state) {
        return {
          isSwiping: true,
    ...
    _defineProperty(_this, "onSwiped", function(data) {
      ...
      if (goodToGo) {
        ...
        if (verticalMode) {
          ...
          var numberOfSlidesViaSwipe = Math.ceil(
          ...
          var numberOfSlidesTogo = Math.max(
            itemsToScroll,
          ...
          // get number of slides from user's swiping
          var _numberOfSlidesViaSwipe = Math.ceil(
            (absX - minSwipeDistanceHorizontal) / childWidth
          );
          // if user swipes more than itemsToScroll then we want to bypass itemsToScroll for a smoother scroll
          var _numberOfSlidesTogo = Math.max(
            itemsToScroll,
            _numberOfSlidesViaSwipe
          );
    ...
    _defineProperty(_this, "generatePositionUpdater", function(
      direction,
      nextItemId,
      verticalMode,
      rest
    ...
    _defineProperty(_this, "goTo", function(nextItemId) {
      ...
      var stateUpdater = _this.generatePositionUpdater(
        direction,
        safeNextItemId,
        verticalMode,
        {
      ...
      _this.setState(stateUpdater, function() {
        // callback
        pipe(
          _this.updateActivePage(),
          _this.onSliderTransitionEnd(positionEndCb)
        );
      });
    });
  ...
  return _createClass(Carousel, [
    ...
    },
    {
      ...
      value: function componentDidUpdate(prevProps, prevState) {
        ...
        var prevChildrenLength = React.Children.toArray(prevProps.children)
          .length;
      ...
      value: function render() {
        ...
        var _this$getDerivedProps23 = this.getDerivedPropsFromBreakPoint(),
          ...
          autoTabIndexVisibleItems =
            _this$getDerivedProps23.autoTabIndexVisibleItems,
          ...
          preventDefaultTouchmoveEvent =
            _this$getDerivedProps23.preventDefaultTouchmoveEvent,
        ...
        return /*#__PURE__*/ React.createElement(
          CarouselWrapper,
          {
            isRTL: isRTL,
            className: ""
              .concat(cssPrefix("carousel-wrapper"), " ")
              .concat(className),
            style: style,
          },
          /*#__PURE__*/ React.createElement(
